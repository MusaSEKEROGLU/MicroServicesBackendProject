...
namespace Microservices.ShoppingDiscounts.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDiscountService, DiscountService>(); //ekledik

            //Koruma altýna almak IdentityServer.Api-Cofig.cs
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(opt =>
            {
                opt.Authority = Configuration["IdentityServerURL"];
                opt.Audience = "resource_shopping_discount";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Microservices.ShoppingDiscounts.Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservices.ShoppingDiscounts.Api v1"));
            }
